...
workspace-warring = 워크스페이스는 탭 그룹 애드온과 같이 사용할 수 없습니다. 탭 그룹 애드온을 사용하고 싶으신 경우, 워크스페이스를 끄시고, { -brand-short-name} 를 재시작해주세요.
...
firefox-proton-fix =
 .label = Firefox Proton FIX 디자인

firefox-photon-lepton =
 .label = Firefox Photon・Lepton 디자인

floorp-legacy =
 .label = Floorp Legacy 디자인 (지원 대상 외)

floorp-fluentUI =
 .label = Microsoft Fluent UI 디자인

floorp-fluerialUI =
 .label = Floorp Fluerial UI 디자인

floorp-gnomeUI =
 .label = GNOME 데스크탑 디자인 (시스템 테마 및 GTK가 필요)
...
macOS-chrome-useragent-mode =
 .label = macOS 상의 Chrome 의 사용자 에이전트를 사용하기
linux-chrome-useragent-mode =
 .label = Linux 상의 Chrome 의 사용자 에이전트를 사용하기
mobile-chrome-useragent-mode =
 .label = iOS 상의 Chrome 의 사용자 에이전트를 사용하기
use-custom-useragent-mode =
 .label = 커스텀 사용자 에이전트를 사용하기

## DMR UI
download-mgr-UI =
 .label = 다운로드 관리자의 UI를 단순하게 하기
downloading-red-color =
 .label = 다운로드 중의 표시를 빨간색으로 바꾸기
